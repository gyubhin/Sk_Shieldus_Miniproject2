...
function PrivacyPage() {
  ...
  return (
    <CommonLayout>
      <BackHeader title="개인정보처리방침" onBackEvent={() => nav(-1)} />
          ...
          <section className={styles.card}>
            <article className={styles.article}>
              ...
              <p>
                ...
                개인정보를 안전하게 보호하기 위해 최선을 다합니다. 본 방침은 개인정보의
                수집·이용·보관·파기에 관한 사항을 명확히 합니다.
              </p>
              <ol>
              ...
              <p>
                회사는 관련 법령의 변경 또는 서비스 정책의 변경에 따라 본 방침을 개정할 수 있으며,
                개정 시 웹사이트 공지사항 등을 통해 안내합니다.
              </p>
            </article>
          </section>
