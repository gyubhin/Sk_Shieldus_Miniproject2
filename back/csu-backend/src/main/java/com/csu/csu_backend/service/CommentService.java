...
public class CommentService {
    ...
    public PagingResponse<CommentDTO.MyCommentResponse> getMyComments(Long userId, Pageable pageable) {
        User user = findUserById(userId);
        Page<Comment> commentsPage = commentRepository.findByUser(user, pageable);
        return PagingResponse.of(commentsPage.map(CommentDTO.MyCommentResponse::new));
    }
